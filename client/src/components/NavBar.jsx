...
const NavBar = ({ refs }) => {
  ...
  return (
    ...
    >
      <div className={`hidden md:flex font-Wind w-[5rem] ${
        Scroll &&
        !Open &&
        "transition-all ease-linear duration-300 bg-opacity-80 md:bg-transparent bg-black backdrop-blur-[20px]"
      ...
      >
        ...
        >
          <li onClick={() => scrollToTop()} className="custom-link">
            Home
          </li>
          <li onClick={() => scrollToSection(about)} className="custom-link">
            About
          </li>
          <li onClick={() => scrollToSection(services)} className="custom-link">
            Services
          </li>
          <li onClick={() => scrollToSection(works)} className="custom-link">
            Works
          </li>
          <li onClick={() => scrollToSection(contact)} className="custom-link">
            Contact
          </li>
        </ul>
